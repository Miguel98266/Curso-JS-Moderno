...
const paginaciondiDiv = document.querySelector('#paginacion');
...
function buscarImagenes() {
    ...
    const key = '23455770-5b6e0a401e9b976c78d1f0b06';
...
function mostrarImagenes(imagenes) {
    ...
    while (paginaciondiDiv.firstChild) {
        paginaciondiDiv.removeChild(paginaciondiDiv.firstChild)
    }
...
function imprimirPaginador() {
    ...
    while (true) {
        ...
        paginaciondiDiv.appendChild(boton);
    }
